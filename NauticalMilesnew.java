import java.util.*;
   ...
   {  
      ...
      final public double NM2KM= 1.852;
      
      final public double NM2Mile= 1.150779;
      ...
      System.out.println("I/P number is " + nauticalmiles + "Nautical Miles is" + miles + "Miles is " + kilometers + "Kilometers is" );
      }
      }